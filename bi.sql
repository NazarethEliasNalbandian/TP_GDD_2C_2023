...
CREATE TABLE SQLSQUAD.BI_Pago(
    ...
    PAGO_IMPORTE              numeric(18, 2)    NULL,
    PAGO_FECHA_VENCIMIENTO    datetime          NULL,
...
AS
SELECT DISTINCT TIEMPO_AÑO, TIEMPO_CUATRIMESTRE, TIPO_OPERACION_NOMBRE, TIPO_INMUEBLE_NOMBRE, MAYOR_A_100, ENTRE_75_Y_100, ENTRE_55_75, ENTRE_35_Y_55, MENOR_A_35 , SQLSQUAD.SignoMoneda(TIPO_MONEDA_NOMBRE) + ' '+ AVG(ANUNCIO_COSTO), TIPO_MONEDA_NOMBRE FROM SQLSQUAD.BI_Anuncio
JOIN SQLSQUAD.BI_Tipo_Operacion ON TIPO_OPERACION_ID = ANUNCIO_TIPO_OPERACION_ID
...
AS
SELECT DISTINCT TOP 5 TIEMPO_AÑO, TIEMPO_CUATRIMESTRE, UBICACION_BARRIO, MENOR_A_25, MAYOR_A_50, ENTRE_25_Y_35, ENTRE_35_Y_50, COUNT(*) 
...
SELECT t1.TIEMPO_AÑO, s.SUCURSAL_CODIGO, r.RANGO_ETARIO_ID, 
	...
	WHERE (a2.ANUNCIO_ESTADO_ANUNCIO_ID = 1 or a2.ANUNCIO_ESTADO_ANUNCIO_ID = 3)
	AND a2.ANUNCIO_SUCURSAL_CODIGO = s.SUCURSAL_CODIGO
