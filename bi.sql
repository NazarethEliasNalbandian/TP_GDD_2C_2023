...
CREATE TABLE SQLSQUAD.BI_Anuncio(
    ...
    CONSTRAINT PK_ANU PRIMARY KEY NONCLUSTERED (ANUNCIO_TIEMPO_ID, ANUNCIO_AMBIENTES_ID, ANUNCIO_UBICACION_ID, ANUNCIO_TIPO_OPERACION_ID, ANUNCIO_SUCURSAL_CODIGO, ANUNCIO_TIPO_MONEDA_ID, ANUNCIO_RANGO_M2_ID, ANUNCIO_TIPO_INMUEBLE_ID, ANUNCIO_RANGO_ETARIO_ID)
)
go
...
AS
BEGIN
	INSERT INTO SQLSQUAD.BI_Anuncio(ANUNCIO_TIEMPO_ID, ANUNCIO_AMBIENTES_ID, ANUNCIO_UBICACION_ID, ANUNCIO_TIPO_OPERACION_ID, ANUNCIO_SUCURSAL_CODIGO, ANUNCIO_TIPO_MONEDA_ID, ANUNCIO_RANGO_M2_ID, ANUNCIO_TIPO_INMUEBLE_ID, ANUNCIO_RANGO_ETARIO_ID, ANUNCIO_DURACION_PROMEDIO, ANUNCIO_COSTO)
	SELECT
		(SELECT TIEMPO_ID 
...
AS
SELECT AVG(v.comision), ti.TIPO_OPERACION_NOMBRE,t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE 
FROM SQLSQUAD.BI_Venta_inmueble v
...
UNION ALL
SELECT AVG(a.comision), ti.TIPO_OPERACION_NOMBRE,t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE 
...
AS
--chequear
SELECT (SELECT COUNT() FROM  SQLSQUAD.BI_Anuncio a WHERE a.ANUNCIO_ESTADO = 'finalizado')*100/COUNT()
