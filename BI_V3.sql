...
CREATE TABLE SQLSQUAD.BI_Alquiler(
    ...
    CONSTRAINT PKALQUIL8 PRIMARY KEY NONCLUSTERED (ALQUILER_TIEMPO_ID, ALQUILER_UBICACION_ID, ALQUILER_RANGO_M2_ID, ALQUILER_TIPO_INMUEBLE_ID, ALQUILER_TIPO_OPERACION_ID, ALQUILER_AMBIENTES_ID, ALQUILER_RANGO_ETARIO_ID, ALQUILER_SUCURSAL_CODIGO, ALQUILER_PAGO_ID, ALQUILER_ESTADO_ALQUILER_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Ambientes(
    ...
    CONSTRAINT PKAMBIEN11 PRIMARY KEY NONCLUSTERED (AMBIENTES_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Anuncio(
    ...
    CONSTRAINT PKANUNCI1 PRIMARY KEY NONCLUSTERED (ANUNCIO_TIEMPO_ID, ANUNCIO_AMBIENTES_ID, ANUNCIO_UBICACION_ID, ANUNCIO_TIPO_OPERACION_ID, ANUNCIO_SUCURSAL_CODIGO, ANUNCIO_TIPO_MONEDA_ID, ANUNCIO_RANGO_M2_ID, ANUNCIO_TIPO_INMUEBLE_ID, ANUNCIO_RANGO_ETARIO_ID, ANUNCIO_ESTADO_ANUNCIO_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Estado_alquiler(
    ESTADO_ALQUILER_ID        numeric(18, 0)    NOT NULL,
    ESTADO_ALQUILER_NOMBRE    nvarchar(100)     NULL,
    CONSTRAINT PKESTALQ22 PRIMARY KEY NONCLUSTERED (ESTADO_ALQUILER_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Estado_Anuncio(
    ...
    CONSTRAINT PKESTANUN23 PRIMARY KEY NONCLUSTERED (ESTADO_ANUNCIO_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Pago(
    ...
    CONSTRAINT PKPAGOO19 PRIMARY KEY NONCLUSTERED (PAGO_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Rango_Etario(
    ...
    CONSTRAINT PKR_ETT6 PRIMARY KEY NONCLUSTERED (RANGO_ETARIO_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Rango_m2(
    ...
    MENOR_A_35        bit               NULL,
    CONSTRAINT PKRMM213 PRIMARY KEY NONCLUSTERED (RANGO_M2_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Sucursal(
    ...
    CONSTRAINT PKSUCURS PRIMARY KEY NONCLUSTERED (SUCURSAL_CODIGO)
)
go
...
CREATE TABLE SQLSQUAD.BI_Tiempo(
    ...
    TIEMPO_AÑO             int               NULL,
    TIEMPO_DIA             int               NULL,
    CONSTRAINT PKTIMEPOO PRIMARY KEY NONCLUSTERED (TIEMPO_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Tipo_inmueble(
    ...
    CONSTRAINT PK7TIP_INMU PRIMARY KEY NONCLUSTERED (TIPO_INMUEBLE_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Tipo_moneda(
    ...
    CONSTRAINT PK7_TIP_MON1_1 PRIMARY KEY NONCLUSTERED (TIPO_MONEDA_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Tipo_operacion(
    ...
    CONSTRAINT PK7_TIP_OPP1 PRIMARY KEY NONCLUSTERED (TIPO_OPERACION_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Ubicacion(
    ...
    CONSTRAINT PKUBICAC PRIMARY KEY NONCLUSTERED (UBICACION_ID)
)
go
...
CREATE TABLE SQLSQUAD.BI_Venta_inmueble(
    ...
    CONSTRAINT PKVENTA10 PRIMARY KEY NONCLUSTERED (VENTA_TIEMPO_ID, VENTA_RANGO_M2_ID, VENTA_AMBIENTES_ID, VENTA_TIPO_OPERACION_ID, VENTA_TIPO_MONEDA_ID, VENTA_TIPO_INMUEBLE_ID, VENTA_UBICACION_ID, VENTA_SUCURSAL_CODIGO)
)
go
...
ALTER TABLE SQLSQUAD.BI_Alquiler ADD CONSTRAINT [RefSQLSQUAD.BI_Estado_alquiler33] 
...
ALTER TABLE SQLSQUAD.BI_Anuncio ADD CONSTRAINT [RefSQLSQUAD.BI_Estado_Anuncio32] 
...
ALTER PROCEDURE MigrarDatosBI_Estado_Anuncio
AS 
BEGIN
	 INSERT INTO SQLSQUAD.BI_Estado_Anuncio(ESTADO_ANUNCIO_ID, ESTADO_ANUNCIO_NOMBRE)
	 SELECT E.ESTADO_ANUNCIO_ID, ESTADO_ANUNCIO_NOMBRE FROM SQLSQUAD.estado_anuncio E
END

GO
ALTER PROCEDURE MigrarDatosBI_Estado_Alquiler
AS 
BEGIN
	 INSERT INTO SQLSQUAD.BI_Estado_Alquiler(ESTADO_ALQUILER_ID,ESTADO_ALQUILER_NOMBRE)
	 SELECT E.ESTADO_ALQUILER_ID, E.ESTADO_ALQUILER_NOMBRE FROM SQLSQUAD.estado_alquiler E
END


ALTER PROCEDURE MigrarDatosBI_Rango_Etario
AS
BEGIN
...
GO
ALTER PROCEDURE MigrarDatosBI_Sucursal
AS
BEGIN
...
END
GO
ALTER PROCEDURE MigrarDatosBI_Ubicacion
AS
BEGIN
...
GO
ALTER PROCEDURE MigrarDatosBI_Tiempo
AS
BEGIN
...
GO
ALTER PROCEDURE MigrarDatosBI_Tipo_Operacion
AS
BEGIN
...
GO
ALTER PROCEDURE MigrarDatosBI_Rango_m2
AS
BEGIN
...
GO
ALTER PROCEDURE MigrarDatosBI_Tipo_Moneda
AS
BEGIN
...
END
GO
ALTER PROCEDURE MigrarDatosBI_Tipo_Inmueble
AS
BEGIN
...
ALTER PROCEDURE MigrarDatosBI_Ambientes
AS
BEGIN
...
ALTER PROCEDURE MigrarDatosBI_Pago
AS 
BEGIN
...
ALTER PROCEDURE MigrarDatosBIAnuncio
AS
BEGIN
	...
	join SQLSQUAD.estado_anuncio ea ON ea.ESTADO_ANUNCIO_ID = ANUNCIO_ESTADO_ANUNCIO_ID
...
AS
BEGIN
	INSERT INTO SQLSQUAD.BI_Alquiler(ALQUILER_TIEMPO_ID, ALQUILER_AMBIENTES_ID, ALQUILER_UBICACION_ID, ALQUILER_TIPO_OPERACION_ID, ALQUILER_SUCURSAL_CODIGO, ALQUILER_RANGO_M2_ID, ALQUILER_TIPO_INMUEBLE_ID, ALQUILER_RANGO_ETARIO_ID, ALQUILER_PAGO_ID, ALQUILER_ESTADO_ALQUILER_ID)
	SELECT
		(SELECT TIEMPO_ID 
		from SQLSQUAD.BI_Tiempo
		where TIEMPO_AÑO = year(a.ALQUILER_FECHA_INICIO) 
		and TIEMPO_CUATRIMESTRE = DATEPART(QUARTER, a.ALQUILER_FECHA_INICIO)
		and TIEMPO_MES = month(a.ALQUILER_FECHA_INICIO)),
	I.INMUEBLE_CANT_AMBIENTES_ID,
		(SELECT UBICACION_ID 
		from SQLSQUAD.BI_Ubicacion
		where UBICACION_BARRIO = b.BARRIO_NOMBRE
	...
	join SQLSQUAD.estado_alquiler ea on ea.ESTADO_ALQUILER_ID = A.ALQUILER_ESTADO_ALQUILER_ID
...
ALTER PROCEDURE MigrarDatosBIVenta
AS
BEGIN
...
AS
SELECT DISTINCT TOP 5 TIEMPO_AÑO, TIEMPO_CUATRIMESTRE, UBICACION_BARRIO, MENOR_A_25, MAYOR_A_55, ENTRE_25_Y_35, ENTRE_35_Y_50, COUNT(*) 
...
JOIN sqlsquad.BI_Rango_Etario on ALQUILER_RANGO_ETARIO_ID = RANGO_ETARIO_ID
...
AS
SELECT t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE, i.TIPO_INMUEBLE_NOMBRE, u.UBICACION_LOCALIDAD, AVG(v.venta_precio)
...
GROUP BY t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE, i.TIPO_INMUEBLE_NOMBRE, u.UBICACION_LOCALIDAD
GO
...
AS
SELECT t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE, ti.TIPO_OPERACION_NOMBRE, s.SUCURSAL_CODIGO, AVG(v.VENTA_COMISION)
FROM SQLSQUAD.BI_Venta_inmueble v
...
GROUP BY t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE, ti.TIPO_OPERACION_NOMBRE, s.SUCURSAL_CODIGO
UNION ALL
SELECT t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE, ti.TIPO_OPERACION_NOMBRE, s.SUCURSAL_CODIGO, AVG(a.ALQUILER_COMISION)
...
AS
SELECT t1.TIEMPO_AÑO, s.SUCURSAL_CODIGO, r.RANGO_ETARIO_ID, 
	(SELECT COUNT(*) 
	FROM SQLSQUAD.BI_Anuncio a2 
	JOIN SQLSQUAD.BI_Tiempo t2 ON a2.ANUNCIO_TIEMPO_ID = t2.TIEMPO_ID
	WHERE (a.ANUNCIO_ESTADO_ANUNCIO_ID = 1 or a.ANUNCIO_ESTADO_ANUNCIO_ID = 3)
	AND a.ANUNCIO_SUCURSAL_CODIGO = s.SUCURSAL_CODIGO
	AND t2.TIEMPO_AÑO = t1.TIEMPO_AÑO)* 100 / COUNT(*)
FROM SQLSQUAD.BI_Anuncio a1
JOIN SQLSQUAD.BI_Sucursal s on s.SUCURSAL_CODIGO = a1.ANUNCIO_SUCURSAL_CODIGO
JOIN SQLSQUAD.BI_Tiempo t1 on t1.TIEMPO_ID = a1.ANUNCIO_TIEMPO_ID
JOIN SQLSQUAD.BI_Rango_Etario r ON r.RANGO_ETARIO_ID = a1.ANUNCIO_RANGO_ETARIO_ID
GROUP BY t1.TIEMPO_AÑO, s.SUCURSAL_CODIGO, r.RANGO_ETARIO_ID
...
CREATE VIEW SQLSQUAD.monto_total_cierre_contratos
AS
SELECT t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE, ti.TIPO_OPERACION_NOMBRE, s.SUCURSAL_CODIGO, SUM(v.venta_precio)
FROM SQLSQUAD.BI_Venta_inmueble v
JOIN SQLSQUAD.BI_Sucursal s on s.SUCURSAL_CODIGO = v.VENTA_SUCURSAL_CODIGO
JOIN SQLSQUAD.BI_Tiempo t ON t.TIEMPO_ID = v.VENTA_TIEMPO_ID
JOIN SQLSQUAD.BI_Tipo_operacion ti on v.VENTA_TIPO_OPERACION_ID = ti.TIPO_OPERACION_ID
GROUP BY t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE, ti.TIPO_OPERACION_NOMBRE, s.SUCURSAL_CODIGO
UNION ALL
SELECT t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE, ti.TIPO_OPERACION_NOMBRE, s.SUCURSAL_CODIGO, SUM(p.pago_importe)
FROM SQLSQUAD.BI_Alquiler a
JOIN SQLSQUAD.BI_Sucursal s on s.SUCURSAL_CODIGO = a.ALQUILER_SUCURSAL_CODIGO
JOIN SQLSQUAD.BI_Tiempo t ON t.TIEMPO_ID = a.ALQUILER_TIEMPO_ID
JOIN SQLSQUAD.BI_Tipo_operacion ti on a.ALQUILER_TIPO_OPERACION_ID = ti.TIPO_OPERACION_ID
JOIN SQLSQUAD.BI_Pago p ON p.PAGO_ID = a.ALQUILER_PAGO_ID
GROUP BY t.TIEMPO_AÑO, t.TIEMPO_CUATRIMESTRE, ti.TIPO_OPERACION_NOMBRE, s.SUCURSAL_CODIGO
GO
